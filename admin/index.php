    ...
    <div class="row " >
        ...
        <div class="col-lg-3 col-12  p-2  " >
           ...
           <div class="bod p-4">
                ...
                <div class="row g-3">
                    <div class="col-lg-12 col-2  bod  container active tab ">
                        <a href="index" style="text-decoration: none;" class="active">
        ...
        <main class="col-lg-9 col-12 p-3">
            ...
            <div class="col-12 mt-3">
                ...
                <div class="row container mb-5">
                    <div class="bod col-10 col-lg-3 p-3 mt-5">
                        <h1 class="text-center"><?=mysqli_num_rows(fetchItems('user','id')) ?><sup>+</sup></h1><h3 class="text-center">Users</h3>
                    </div>
                    <div class="bod col-10 col-lg-3 active p-3 mt-5">
                         <h1 class="text-center"><?=mysqli_num_rows(fetchItems('quiz','id')) ?><sup>+</sup></h1><h3 class="text-center">Quiz</h3>
                    </div>
                    <div class="bod col-10 col-lg-3 p-3 mt-5">
                    <h1 class="text-center"><?=mysqli_num_rows(fetchItems('questions','id')) ?><sup>+</sup></h1><h3 class="text-center">Questions</h3>
                    </div>
                </div>
                
                <div class="row mb-3">
                    <div class="bod col-lg-7 p-3 col-md-12 mb-3">
                        <div class=" p-2">
                            <h5><i class="ti ti-list"></i> Top 3 Users</h5>                          
                            <table class="table text-left">
                                ...
                                <?php 
                                $i = 0;
                                 foreach (fetchItems('leaderboard','points',3) as $row ){
                                    extract($row);
                                    $i++;
                                    ?>
                                    <tr >
                                        <td><?=$i?></td>
                                        <td><?php foreach(fetchWhere('user','userid',$userid) as $key){ echo $key['username'];}?></td>
                                        <td><?=$points?></td>
                                    </tr>
                                    <?php }?>
                    ...
                    <?php 
                        $row = mysqli_fetch_assoc(fetchItems('leaderboard','points', 1));
                        if (isset($row)) {
                    ...
                    <div class=" col-lg-4 col-12 row">
                        <div class="text-center p-1 pt-3 bod mb-3 col-lg-10 col-10 active">  
                            <h3>Top User</h3>
                               <div class="bg-light mt-3 rounded-circle" style="overflow: hidden;width: 100px;"> 
                               <?php
                             $table = fetchWhere('user','userid',$userid);
                             foreach($table as $key){
                                extract($key);
                        ?>
                                <img src="../user/img/<?=$userimage?>" alt="not found" class="img-fluid " width="100">
                            </div>
                            <h1><?=$username?> : <?=$points?></h1>                            
                            <?php } ?>
                        </div>
                    </div>
                    <?php } ?>
