...
<body>
    <div class="row " >
        ...
        <main class="col-lg-9 col-12 p-3">
            ...
            <div class="col-12 mt-3 bod" style="overflow-x: scroll;">
            <a href="add?user=admin"  class="btn btn-primary m-3">Add</a>
            <div class=" p-3 ">
                 <table class="table table-striped " style="max-height:90vh;overflow-y:scroll;">
                        ...
                        <tbody>
                            <?php 
                            $pos = 1;
                                foreach(fetchItems('quiz','id') as $key){
                                    extract($key);
                            ...
                            <tr>
                                ...
                                <td><?=$quiztype?></td>
                                <td><?= $quizmarks?></td>
                                <td><?= $quiztime?> min(s)</td>
                                <?php foreach(fetchWhere('user','userid',$quizauthor) as $row)?>
                                    <?php if($quizauthor == 'admin'){
                                        ?>
                                <td><?= $quizauthor ?></td>
                                <?php } else {?>
                                    <td><?= $row['username'] ?></td>
