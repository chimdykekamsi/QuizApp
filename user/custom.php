        ...
        <main class="col-lg-9 col-12 p-3">
            ...
            <div class="col-12 mt-3 p-3">
               ...
               <div class="col-lg-6 ">
                    <form action="" method="post" class="was-validated">
                       ...
                       ?>
                        ...
                        <button class="btn btn-primary col-12" type="submit" name="submitquiz" onclick="javascript: return confirm('This will cost you 200 points?')">Next</button>
               ...
               <div class="col-lg-6 mt-3">                               
                   ...
                   <div class="input-group mb-3" title="notify users about your quiz">
                        <input type="text" class="form-control col-10"  name="userid" placeholder="User id of your friend ">
                        <button class="btn btn-secondary col-2" name="share"><i class="ti ti-share"></i></button>
                    </div>
                   </form>
                    <?php
                        ...
                        if (isset($_POST['share'])) {
                            $userid = $_POST['userid'];
                            $id =  $_SESSION['userid'];
                            $message = "I created a new Quiz you can take part in the quiz by going to the quiz page and searching with the id $id";
                            addNotify($userid,$message);
                            message("success","User has been notified","user/custom?user=$id");
                        }

                    ?>
                    <div class="row">   
                        <div class="bod col-5 text-center p-3">
                            <h5>My Students</h5>
                            <h3><?php 
                                $usercount = 0;
                                foreach(fetchWhere('quiz','quizauthor',$userid) as $quiz){
                                    extract($quiz);
                                    $usercount += $quizuser;
                                }
                                echo $usercount;
                        ...
                        <div class="bod col-5 text-center p-3">
                            <h5>My Quizes</h5>
                            <h3><?=mysqli_num_rows(fetchWhere('quiz','quizauthor',$userid))?></h3>
                        </div>
                    </div>

                    <h5 class="m-3">My Quiz</h5>
                    <div class=" bod mt-3">
                 <table class="table table-striped " style="max-height:90vh;overflow-y:scroll;">
                        ...
                        <tbody>
                            ...
                            $pos = 1;
                                ...
                                foreach(fetchWhere('quiz','quizauthor',$userid) as $key){
                                    extract($key);
                            ...
                            <tr>
                                ...
                                <td><?=$quizname?></td>
                                <td><?= $quizmarks?></td>
                                <td> <a class="ti ti-trash text-danger" href="?deleteid=<?= $id?>" style="text-decoration:none" title="Delete Quiz" onclick="javascript: return confirm('Confirm Delete?')"></a></td>
                            </tr>
                                    <?php 
                            ...
                            <?php if(mysqli_num_rows(fetchWhere('quiz','quizauthor',$userid)) < 1){echo "<tr><td><h5>Nothing to see here</h5></td></tr>";}?>
                        </tbody>
                 </table>
...
<?php 
    if (isset($_POST['submitquiz'])) {
        ...
        addQuiz($title,$type,$mark,$time,$count);
    ...
    header("Location: custom?options=$quizid");
