            ...
            <div class="col-12 mt-3">
                ...
                <div class="row mb-3">
                    <div class="bod col-lg-7 p-3 col-md-12 mb-3">
                        <div class=" p-2">
                            <h5><i class="ti ti-list"></i> Current Rank on Leaderboard</h5>
                            <?php
                            ...
                            <table class="table text-left">
                                ...
                                <tbody>
                                <?php 
                                 foreach (fetchWhere('leaderboard','userid',$user_id) as $row ){
                                    extract($row);}
                                    $sql = "SELECT * FROM `leaderboard` WHERE `points` > $points  ORDER BY `points` ASC LIMIT 1";
                                    ...
                                    <tr class="<?=$class?>">
                                        <td>
                                        <?php
                                            $sql = " SELECT * FROM leaderboard WHERE `points` >= $points";
                                    ...
                                    <?php }?>
                                    <?php 
                                    $sql = "SELECT * FROM `leaderboard` WHERE `points` < $points ORDER BY `points` DESC LIMIT 1 ";
                                    $result = $conn->query($sql);
                    ...
                    <div class=" col-lg-4 col-12 row">
                        <div class="text-center p-1 pt-3 bod mb-3 col-lg-10 col-5">
                            <h5><i class="ti ti-game"></i><br> Total Points</h5>
                            <?php
                        ...
                        <div class="text-center p-1 pt-3 bod mb-3 col-lg-10 col-5">
                            <h5><i class="ti ti-ruler-pencil"></i><br> Quiz Taken</h5>
                            <h3><?= mysqli_num_rows(fetchWhere('history','userid',$userid))?> of <?= mysqli_num_rows(fetchItems('quiz','id'))?></h3>
               ...
               <div class="row">
                    <div class="col-8">
                        <h3 class="text-center mb-3">Trending Topics</h3>
                    </div>
                    <a href="quiz" class="col-4">View all Quiz</a>
               </div>

                <div class="row">
                <?php foreach(fetchItems('quiz','quizuser',2)as $key){
                        extract($key);
                       
                            
                    ?>
                    <div class="col-lg-5 col-10 bod p-3 mb-3">
                    <h5><?=$quizname?></h5>
                        <div class="col-11 m-3 row">
                            <ul>
                                ...
                                <li>
                                <h5>Completed by <?=$quizuser?> users</h5>
                                </li>
                            </ul>
