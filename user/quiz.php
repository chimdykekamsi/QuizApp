    ...
    <div class="row " >
        ...
        <main class="col-lg-9 col-12 p-3">
            ...
            <div class="col-12 mt-3">
                <div class="col-10 m-3  ">
                    <form action="search" method="post">
                        <div class="input-group">
                            <input class="form-control col-8" type="text" name="searchtag" placeholder="Search by quiz name or type" required>
                            <button class="input-group-append btn btn-primary col-2" name="search" type="submit">
                            Search
                            </button>
                        </div>
                    </form>
                ...
                <div class="row">
                <?php foreach(fetchItems('quiz','quizuser',3)as $key){
                        extract($key);
                ...
                <div class="row">
                    <?php foreach(fetchItems('quiz','id')as $key){
                        extract($key);
                        if ($quizauthor == 'admin'){
                    ...
                    <?php } }
                        if (mysqli_num_rows(fetchItems('quiz','id')) == 0) {
                        ?>
                        <div class="col-10 col-lg-7 bod p-3 m-4  ">
                         <h5 class="text-center">  No Quiz Availablle Yet </h5>                          
                        </div>
                        <?php   }?>
